...
class CalculatorsControllerTest < ActionController::TestCase
  ...
  test "should create calculator" do
    assert_difference('Calculator.count') do
      post :create, calculator: { category_id: @calculator.category_id, description: @calculator.description, featured: @calculator.featured, name: @calculator.name, picture: @calculator.picture }
    end
  ...
  test "should update calculator" do
    patch :update, id: @calculator, calculator: { category_id: @calculator.category_id, description: @calculator.description, featured: @calculator.featured, name: @calculator.name, picture: @calculator.picture }
    assert_redirected_to calculator_path(assigns(:calculator))
  end
